...
const PHONE: string = "31645041484";
const PREFILL: string = "Hallo, ik heb een vraag over kraamzorg bij Marley's Kraamzorg.";
    ...
    <>
      ...
      <button
        ...
        onMouseEnter={(e) => {
          ...
          (e.currentTarget as HTMLButtonElement).style.backgroundColor = "#B52A78";
        }}
        onMouseLeave={(e) => {
          (e.currentTarget as HTMLButtonElement).style.transform = "translateY(0)";
          (e.currentTarget as HTMLButtonElement).style.backgroundColor = "#9A1E61";
        }}
      >
      ...
      <div style={{ position: "fixed", bottom: "80px", right: "24px", zIndex: 9999 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div>
                  <p style={{ fontWeight: 800, fontSize: "14px", textTransform: "uppercase", fontFamily: "var(--font-cinzel), serif" }}>
                    MARLEY&apos;S KRAAMZORG
                  </p>
        ...
        {/* Toggle Button — kleiner, rond, zonder schaduw */}
        <button
        ...
        >
          {waOpen ? <X size={22} strokeWidth={2.5} /> : (
